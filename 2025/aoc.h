...
static inline t_aoc_result aoc_result_ok(void);
...
static inline t_aoc_result aoc_result_ok(void)
{
    return (t_aoc_result){.status = AOC_OK, .obtained = aoc_val_none(), .expected = aoc_val_none()};
}
